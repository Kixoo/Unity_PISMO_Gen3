...
{
    //WEB: http://dreamlo.com/lb/F0lA_oSAWkeuxp-Rib80ZAcC09imRITkyEWp-q30yj4w
    ...
    const string privateCode = "F0lA_oSAWkeuxp-Rib80ZAcC09imRITkyEWp-q30yj4w";
    const string publicCode = "5e4bd69cfe232612b8416d20";
    ...
    public void ChangeDataByMe()
    {
        if (playerName.text != string.Empty)
        {
            ...
            displayHighscore.myHighscore.text = userNick + " - " + PlayerPrefs.GetInt("Highscore") + " bodova";
        }
        else
        {
            Debug.LogError("Input field cannot be empty you fucking dumbass");
        }
    }
